            ...
            <div>
              ...
              <div className="about-socials">
                <a
                  ...
                  href="https://github.com/AmitKumarHota"
                  target="_blank"
                ...
                <a
                  className="social-chip social-chip--surface"
                  href="https://linkedin.com/in/amitkumarhota"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="LinkedIn"
                >
                ...
                <a
                  className="social-chip social-chip--surface"
                  href="mailto:amitkumarhotaiiit@gmail.com"
                  aria-label="Email"
                >
